...
lappend search_path  "/home/ahesham/ASIC_Course/PIT"
...
create_mw_lib   ./${design} \
		...
		-open
###########################################################################################		
################################ Files for Parasitic Extraction ################################
###########################################################################################		
...
## If there still congestion, change ignored layers, if it is still there, increase floorplan area.lllllllllllllllllll
...
#define_routing_rule -multiplier_spacing 2 define_routing_rule -multiplier_width 2
